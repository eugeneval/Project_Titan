...
\footnotetext{Multithreading is a way of optimising computer programs. Instead of a single process, where all tasks occur sequentially, a program is split into multiple processes happening concurrently and communicating with each other.}
